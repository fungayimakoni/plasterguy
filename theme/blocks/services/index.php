...
<div id="<?php echo $id; ?>" <?php echo get_block_wrapper_attributes(); ?>>
    <section class="bg-[#F0F7FC] section-padding ml-8 rounded-bl-[60px] bg-no-repeat bg-bottom" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/renewable-graphic.svg');">
        <div class="wrapper">
                    ...
                    <div class="md:w-1/3">
                        <div class="" data-aos="zoom-in" data-aos-duration="1500">
                            ...
                            <?php if ( $slsection_cta ) : ?>
                                <a href="<?php echo esc_url( $slsection_cta['url'] ); ?>" target="<?php echo esc_attr( $slsection_cta['target'] ); ?>" class="rw-button !inline-block"><?php echo esc_html( $slsection_cta['title'] ); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <div class="lg-blocks swiper pb-12">
                            <div class="swiper-wrapper pb-12">
                                ...
                                <div class="swiper-slide relative rounded-2xl overflow-hidden">
                                    ...
                                    <div class="px-8 py-4 flex-1 flex flex-col items-start absolute left-0 bottom-0 bg-opacity-15 bg-linear-to-t from-[#EE322E] to-[#F79431] w-[80%] rounded-tr-xl">
