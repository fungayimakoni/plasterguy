...
<section id="<?php echo $id; ?>" class="section-divider relative px-6 pb-20">
    <div class="flex relative">
        <div class="w-2/3 absolute left-0 top-0 h-full rounded-bl-[60px] overflow-hidden">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/angled-lines-a.svg" alt="" class="opacity-25 absolute left-0 -bottom-[130px]">
        </div>
        <div class="bg-[#007AC2] w-1/3 absolute right-0 top-0 h-full rounded-tr-[60px]"></div>
        <div class="wrapper flex justify-between gap-12 relative">
            <div class="flex flex-col justify-center w-[45%] py-20">
